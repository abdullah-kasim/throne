...
import { createTab, closeTab, closePane } from "./herdr-tab.service.ts";
...
import { isIndeterminateAgentStartError } from "./herdr-launch-command.ts";
import { PaneReadinessTimeoutError } from "./herdr-readiness.ts";
import type {
  StartOptions,
  AgentStartEvidence,
  StartCallerContext,
...
import { isTransientPaneBusyStartError } from "./herdr-launch-context.ts";
import {
