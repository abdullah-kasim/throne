...
export type ModelBypassAuthorizationEvidence = DurableBypassAuthorizationEvidence;
export type ModelBypassAuthorizationResolution = DurableBypassAuthorizationResolution;
...
export async function authorizeModelBypass(
  ...
  return authorization.kind === "authorized" ? authorization.evidence : undefined;
}
