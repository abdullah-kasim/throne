 ...
 */
export const ALPHA_LIVE_FLOOR_MINIMUM = 5;
...
if (
  ALPHA_LIVE_FLOOR_MINIMUM + ALPHA_AUTOSCALE_HEADROOM >
  ALPHA_AUTOSCALE_HARD_MAXIMUM
) {
  throw new Error("Alpha autoscale ceiling must not exceed the hard maximum");
}
